is a zoomable, pannable time-density chart (histogram / sparkline of a datetime column) with a draggable brush selection used for time animation and date-range filtering of a data source.
